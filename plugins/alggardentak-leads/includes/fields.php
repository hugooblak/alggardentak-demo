...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'alggardentak-leads' ),
				'storm'       => __( 'Storm or hail damage', 'alggardentak-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'alggardentak-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'alggardentak-leads' ),
				'not-sure'    => __( 'Vet inte än', 'alggardentak-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'alggardentak-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'alggardentak-leads' ),
				'research' => __( 'Jag kollar bara priser', 'alggardentak-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'alggardentak-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'alggardentak-leads' ),
		'contacted' => __( 'Kontaktad', 'alggardentak-leads' ),
		'quoted'    => __( 'Quote sent', 'alggardentak-leads' ),
		'won'       => __( 'Won', 'alggardentak-leads' ),
		'lost'      => __( 'Lost', 'alggardentak-leads' ),
		'spam'      => __( 'Misstänkt spam', 'alggardentak-leads' ),
	);
}
